...
<body>
	...
	{
	out.println("<script>alert('Congratulations....Medicine Save Successfull...!')</script>");	
	}
   %>
	<header>		
		<div class="container">
		  ...
		  <div class="col-sm-12 col-md-8">
			...
			try {
				...
				ResultSet rsLogin1 = stRegister1
						.executeQuery("select * from distribute_medicine_info where Medicine_No='"+id+"'");
				if (rsLogin1.next()) {
				...
				ResultSet rs1 = st1
						.executeQuery("select * from user_medicine_info_order where Medicine_No='"+id+"'");
				if (rs1.next()) {
			...
			<form action="u_savemedicine" method="post" class="form-block form-bold form-mb-20 form-h-35 form-brdr-b-grey pr-50 pr-sm-0">
